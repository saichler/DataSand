...
public class JsonEncoder extends AbstractEncoder {
    ...
    private void addEntry(Object value,EncodeDataContainer edc){
        JsonEncodeDataContainer je = (JsonEncodeDataContainer)edc;
        je.addEntry(je.getCurrentAttributeName(),value);
    }
    ...
    public void encodeAugmentations(Object value, EncodeDataContainer edc) {
        IAugmetationObserver ao = edc.getTypeDescriptorContainer().getAugmentationObserver();
        if(ao!=null){
            ao.encodeAugmentations(value, edc);
        }
    }

    @Override
    public void decodeAugmentations(Object builder, EncodeDataContainer edc,Class<?> augmentedClass) {
        // TODO Auto-generated method stub
    ...
    public void encodeObject(Object value, EncodeDataContainer edc) {
       ...
       JsonEncodeDataContainer js = (JsonEncodeDataContainer)edc;
       if(td!=edc.getTypeDescriptor()){
           js = new JsonEncodeDataContainer(td);
           edc.addSubElementData(td.getClassCode(), js, value);
       }
       td.getSerializer().encode(value, js);
    }
    ...
    public void encodeAndAddList(List<?> list, EncodeDataContainer edc,Class<?> componentType) {
        if (list == null) {
            ...
            for (Object o: list) {
                JsonEncodeDataContainer subBA = new JsonEncodeDataContainer(edc.getTypeDescriptorContainer().getTypeDescriptorByCode(componentCode));
