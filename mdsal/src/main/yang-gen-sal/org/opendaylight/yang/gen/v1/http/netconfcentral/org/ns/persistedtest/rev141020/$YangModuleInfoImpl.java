...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-persisted-dom-test";
    private final String namespace = "http://netconfcentral.org/ns/persistedtest";
    private final String revision = "2014-10-20";
    private final String resourcePath = "/META-INF/yang/sal-persisted-dom-test.yang";
